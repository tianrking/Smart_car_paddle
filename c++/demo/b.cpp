       ...
       /////////////////////////////////////////////////////////功能线////////////////////////////////////////////////////////////
        ...
        for (int _y = image_shape_width / 6; _y < image_shape_width; _y++)
        {
             ...
             if ((M_edge[_y] <= image_shape_height / 5) || (M_edge[_y] >= image_shape_height * 4 / 5))
            {
                ...
                // else
                // {
                M_edge[_y] = image_shape_height / 2; //两边空白时自动补中线为屏幕中                                        // flag_lose=1;
                // }
            }
            else
                flag_lose = 0;
        ...
        int _LINE_return_1 = image_shape_width * 0.75;
        int _LINE_return_2 = image_shape_width * 0.85;

        float error = image_shape_height_mid - M_edge[_LINE_return];
        float error_1 = image_shape_height_mid - M_edge[_LINE_return_1];
        float error_2 = image_shape_height_mid - M_edge[_LINE_return_2];

        error = (1.0 * error + 1.0* error_1 + 1.2 * error_2);

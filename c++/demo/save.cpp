...
//image_shape_heigh是高，image_shape_width是长
        ...
        for (int _y=image_shape_width/10; _y <=image_shape_width/2 ; _y++)//顶线判断
        {
            ...
            {
                    circle(draw_line_block_img_gbr,Point(_x,T_edge), 1.5, (10, 12, 90));//顶线
            }
                ...
                if(((int)draw_line_block_img_LINE_BLOCK.at<uchar>(_y, _x) == 255))
                {
                    if(((int)draw_line_block_img_LINE_BLOCK.at<uchar>(_y, _x+1) == 0))
                    {
                        ...
                        {   
                            ...
                            circle(draw_line_block_img_gbr,Point(_x,_y), 5, (110, 12, 90));//右边线
                            R_edge[_y] = _x;
                ...
                {   
                    if(((int)draw_line_block_img_LINE_BLOCK.at<uchar>(_y, _x) == 255))
                    {
                        ...
                        {   
                            ...
                            circle(draw_line_block_img_gbr,Point(_x,_y), 5, (110, 12, 90));// 左边线
                            L_edge[_y] = _x;
...
/////////////////////////////////////////////////////////功能线////////////////////////////////////////////////////////////
        for(int i=0;i<image_shape_width;i++)
       {
        ...
        for (int _y =image_shape_width*3/24 ; _y <= image_shape_width/6; _y++)
		{
            ...
            circle(draw_line_block_img_gbr,Point( M_edge[_y],_y), 2, (110, 245, 200));//中线——前
		}
		for (int _y = image_shape_width/6; _y < image_shape_width; _y++)
		{
            M_edge[_y] = (L_edge[_y]+R_edge[_y])/2;
            if((M_edge[_y]<=image_shape_height/5)||(M_edge[_y]>=image_shape_height*4/5))
            {
                ...
                flag_lose=0;
            circle(draw_line_block_img_gbr,Point( M_edge[_y],_y), 2, (110, 245, 200));//中线
		}
        //////////////////////////////////各种标志位的处理////////////////////////////
        ...
        // }
        ////////////////////////////////偏差处理/////////////////////////////////////
        int _LINE_return = image_shape_width *3/5 ;
        ...
        error=-80;
        circle(draw_line_block_img_gbr,Point(image_shape_height_mid,_LINE_return), 5, (255, 0, 0),2);//检测线
        circle(draw_line_block_img_gbr,Point(image_shape_height_mid,_LINE_return_1), 5, (255, 0, 0),2);//检测线
        circle(draw_line_block_img_gbr,Point(image_shape_height_mid,_LINE_return_2), 5, (255, 0, 0),2);//检测线
        circle(draw_line_block_img_gbr,Point((M_edge[_LINE_return]),_LINE_return), 5, (255, 0, 0),2);
        ...
        string disp1 = std::to_string(flag_lose);
        string disp2 = std::to_string(flag_ahead);
///////////////////////////////////////////////串口发送/////////////////////////////////////
                driver->senddata(11);
